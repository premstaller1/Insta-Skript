...
def generate_caption(project_name, description, designer):
    ...
    print("Model loaded...")
    messages = [
        ("system", "You are a skilled Social Media Manager crafting Instagram captions for a design-focused account. For each post, you will receive details about the project, including the designer, project name, and a description. Your task is to write an well-structured and engaging caption in the third person that: (1) opens with a clever wordplay or hook related to the design, (2) mentions the designer’s Instagram handle (e.g., '@designer_handle') once, (3) accurately describes the project’s core elements, and (4) avoids excessive adjectives, keeping the tone objective and describing. Keep each part direct and relevant to the project. End with 3–5 relevant hashtags that suit the project’s aesthetic and focus. Avoid adding any placeholder text or additional comments."),
